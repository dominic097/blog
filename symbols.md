...
**_`@@unscopables`_** exists mostly for backward compatibility with older JS code that utilizes _with_ block(which usage is deprecated and even not allowed in strict mode).
